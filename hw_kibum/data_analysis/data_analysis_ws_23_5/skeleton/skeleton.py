...
# 12. Trainer 설정 (모델, 데이터셋, 학습 설정, 데이터 전처리 기능 등 포함)
...
trainer = Trainer(
    ...
    tokenizer=tokenizer,                 # 토크나이저 설정 (훈련 과정에서 필요)
    compute_metrics=compute_metrics,     # 매트릭 설정
    data_collator=data_collator          # data collator 설정
)
