...
# 데이터 생성을 위한 공통 함수 정의
def generate_data(model_name, traffic_keywords, gold_samples, max_data=5, k=5):
    """
    ...
    # TODO: ChatOpenAI 모델을 생성해서 데이터 증강에 사용할 gpt-4o-mini 모델을 불러와주세요.
    ...
    for keyword in traffic_keywords:
        ...
        # TODO: 교통 상황에 대한 모범 답변 few_shot_text를 기반으로 keyword에 맞게 예시를 k가지를 작성할 수 있도록 프롬프트를 작성하세요. 결과 형태만 잘 나오면 됩니다.
        prompt = f"""
...
# TODO: generate_data 함수를 통해 'gpt' 모델, 키워드 리스트, 예시 답변 리스트, 최대 생성 데이터 수=5, 한 번에 생성할 답변 수= 5로 선언하세요. 
gpt_texts, gpt_embeddings = _______________________________