...
def generate_financial_text(prompt, max_tokens=300, temperature=0.7):  # OpenAI API를 사용하여 주어진 프롬프트에 기반한 금융 텍스트를 생성합니다.
...
def evaluate_text_quality(text):  # 생성된 텍스트의 품질을 평가
