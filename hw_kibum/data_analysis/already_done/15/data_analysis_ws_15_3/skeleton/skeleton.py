...
scaler = __________________________________
# scaler를 사용해 변환합니다.
# fit_transform(): 훈련 데이터에 대해 평균과 표준편차를 계산하고, 그 값으로 데이터를 표준화합니다.
# transform(): 훈련 데이터에서 계산된 평균과 표준편차를 사용하여 테스트 데이터를 표준화합니다.
X_train_scaled = __________________________________  # 훈련 데이터를 스케일링
X_test_scaled = __________________________________  # 테스트 데이터를 스케일링
...
knn = __________________________________
