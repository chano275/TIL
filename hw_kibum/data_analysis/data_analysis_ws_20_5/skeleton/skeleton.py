...
# ------------------------- RNN 모델 정의 --------------------------------------------
# 텍스트 데이터를 처리할 사용할 수 있도록 RNN(Recurrent Neural Network) 모델을 정의합니다.
